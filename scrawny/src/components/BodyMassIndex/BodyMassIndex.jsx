...
const BodyMassIndex = ({goal, height, lastMeasure}) => {  
  ...
  const BMI = (lastMeasure.weight / (Math.pow( (height/100), 2))).toFixed(2)*1; 
  ...
  return (
    ...
    <div className="compare-weight"> 
        <div className="current-weight">
            ...
            <div className="count-weight weight-now">{lastMeasure.weight}</div>
            <p className="describe-box">{lastMeasure.date}</p>
        </div>

        <div className="wanted-weight">
            <p className="weight-label">Desired weight</p>
            <div className="count-weight desired-weight">{goal}</div>
            <p className="describe-box accent">{lastMeasure.weight-goal} kg left</p>  
        </div> 
    </div>
    ...
    <div className="speedometer"> 
     ...
     <p className="speedometer-describe"> <span>{height} cm</span> <span>{lastMeasure.weight} kg</span> </p>
    </div>
